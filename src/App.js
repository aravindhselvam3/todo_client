...
function App() {
  ...
  const renderUpdateForm = () => (
    <form className="update-form" onSubmit={(e)=>{updateItem(e)}} >
      <input className="update-new-input" type="text" placeholder="Your New list" onChange={e=>{setUpdateItemText(e.target.value)}} value={updateItemText} />
  ...
  return (
    <div className="App">
      ...
      <form className="form" onSubmit={e => addItem(e)}>
        <input type="text" placeholder='Add Your New Todo list' onChange={e => {setItemText(e.target.value)} } value={itemText} />
